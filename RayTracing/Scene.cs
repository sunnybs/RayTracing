...
namespace RayTracing
{
    public static class Scene
    {
        ...
        public static Color BackgroundColor = Color.DarkCyan;

        public static IReadOnlyList<Sphere> Objects = new List<Sphere>
        {
            new Sphere(new Vector3(-1, -8, 25), 0.3f, Color.CornflowerBlue, 1000, 0.3f),
            new Sphere(new Vector3(1, -8, 25), 0.3f, Color.CornflowerBlue, 1000, 0.3f),
            ...
            new Sphere(new Vector3(0, 0, 30), 5f, Color.White, 100, 0.2f),
            new Sphere(new Vector3(0, 10, 30), 6f, Color.White, 10, 0.3f),
        };
